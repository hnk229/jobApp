...
class Shortlistedjobs extends StatefulWidget {
  const Shortlistedjobs({super.key});

  @override
  State<Shortlistedjobs> createState() => _ShortlistedjobsState();
}

class _ShortlistedjobsState extends State<Shortlistedjobs> {
